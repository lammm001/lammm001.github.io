(function () {
  ...
  function VideoCdn(_component, _params) {
    ...
    this.search = function (_params, kinopoiskId) {
      origTitle = params.movie.original_title || params.movie.original_name;
      network.silent('https://vi1pr.netlify.app/pr/http://videocdn.tv/api/short?api_token=3i40G5TSECmLF77oAqnEgbx61ZWaOYaE&imdb_id=' + encodeURIComponent(params.movie.imdb_id), function onComplete(json) {
        try {
  ...
  (function () {
    ...
    var API = 'https://vi1pr.netlify.app/pr/http://api.lampa.stream/',
        cards,
        ping_auth;
    var Modss = {
      init: function init() {
