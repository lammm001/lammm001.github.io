...
(function () {
    ...
    var API = 'https://cr-jgp4.onrender.com/http://api.lampa.stream/', type = '', cards, ping_auth;
    ...
    function rezka(component, _object) {
        var network = new Lampa.Reguest();
        var extract = {};
        // var embed1 = 'https://cr-jgp4.onrender.com/' + 'https://hdrezka.ag/';
        ...
        function getPage(url) {
            ...
            url1 = url.replace('http://hdrezka0ddqyq.org', 'https://cr-jgp4.onrender.com/' + 'https://hdrezka.ag/');
        ...
        this.find = function () {
            ...
            var vcdn_search = function vcdn_search() {
                ...
                if (balanser == 'videoapi') {
                    url = 'https://cr-jgp4.onrender.com/http://5100.svetacdn.in/api/short';
                    url = Lampa.Utils.addUrlComponent(url, 'api_token=qR0taraBKvEZULgjoIRj69AJ7O6Pgl9O');
                } else {
                    url = 'https://cr-jgp4.onrender.com/http://videocdn.tv/api/short';
