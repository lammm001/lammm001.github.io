    ...
    this.find = function () {
        ...
        const pillow = (a, c) => {
            ...
            if (balanser !== 'videocdn') {
                network.native('https://cr.clash-corwin3.workers.dev/?https://kinopoiskapiunofficial.tech/api/v2.1/films/search-by-keyword?keyword=' + encodeURIComponent(query), (json) => {
