...
(function () {
    ...
    var version_modss = '3.0', API = 'http://api.lampa.stream/', type = '', jackets = {}, cards, ping_auth, manifest,
        menu_list = [], vip = false, user_id = '', uid = '490a2c8bc0ca38f46539b76a7b887634', IP, logged = false;
    ...
    var ForkTV = {
        ...
        openBrowser: function (url) {
            if (Lampa.Platform.is('tizen')) {
                ...
                tizen.application.launchAppControl(e, null, function () {
                }, function (e) {
                    Lampa.Noty.show(e);
                });
    ...
    var Pub = {
        ...
        openBrowser: function (url) {
            if (Lampa.Platform.is('tizen')) {
                ...
                tizen.application.launchAppControl(e, null, function (r) {
                }, function (e) {
                    Lampa.Noty.show(e);
                });
            } else if (Lampa.Platform.is('webos')) {
        ...
        function getPage(url) {
            ...
            network["native"](embed + url, function (str) {
                ...
                if (MOVIE_ID && IDENTIFIER && PLAYER_CUID) {
                    ...
                    network.clear();
                    network.timeout(1000 * 10);
                    network["native"](embed + user_url, function () {
                    }, function () {
                    }, false, {
                        dataType: 'text',
